...
For example, a country term in the ISO 3166 vocabulary might carry identifiers and multilingual titles in `_code` and `_info`, while `_prop` records the country's international dialling code, geographical area, spoken languages, official currencies, and neighbouring countries — facts that belong to the entity, not to its dictionary representation.
...
```json
{
	"_prop": {
		...
		"std_country_borders": ["ISO_3166_3_AUT", "ISO_3166_3_FRA", "ISO_3166_3_SMR", "ISO_3166_3_SVN", "ISO_3166_3_CHE", "ISO_3166_3_VAT"]
	}
}
```
