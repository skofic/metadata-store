...
Every [`_set`](_set.md) must contain exactly one `_scalar_set` object. It declares the data type of the set elements using [`_type_scalar_set`](_type_scalar_set.md), which accepts all types from [`_type_scalar`](_type_scalar.md) except those that are not comparable: [`_type_string_Markdown`](_type_string_Markdown.md), [`_type_string_SVG`](_type_string_SVG.md), [`_type_string_LaTeX`](_type_string_LaTeX.md), [`_type_string_regexp`](_type_string_regexp.md), [`_type_object`](_type_object.md), [`_type_struct`](_type_struct.md), and [`_type_object_GeoJSON`](_type_object_GeoJSON.md).
