...
A set of descriptor global identifiers that must never appear in the object. If any banned property is present the object is invalid. Unconditional and absolute — takes precedence over all other rules including conditional graph rules.

**`_description`**

This is a property of the [`_rule`](_rule.md) section. Its value is a flat set of descriptor [`_gid`](_gid.md)s. If any of the listed properties is present in the object, validation fails — the object is considered invalid, not simply cleaned up.
