...
The optional [_set_scalar](_set_scalar.md) property defines the element type using [_set_type](_set_type.md) along with optional constraints such as [`_kind_string_key`](_kind_string_key.md), [`_kind_string_enum`](_kind_string_enum.md), [`_valid-range`](_valid-range.md), or [`_regexp`](_regexp.md). When `_set_scalar` is absent, the set accepts any comparable type.
